 ...
 * <ul>
 *   <li>{@link cleaningrobots.impl.DiscoverBehaviourImpl#getRobot <em>Robot</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DiscoverBehaviourImpl extends MinimalEObjectImpl.Container implements DiscoverBehaviour {
		...
		if (robot != null && robot.eIsProxy()) {
			...
			if (robot != oldRobot) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CleaningrobotsPackage.DISCOVER_BEHAVIOUR__ROBOT, oldRobot, robot));
			}
		}
		return robot;
	}
	...
	public void setRobot(Robot newRobot) {
		...
		robot = newRobot;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CleaningrobotsPackage.DISCOVER_BEHAVIOUR__ROBOT, oldRobot, robot));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CleaningrobotsPackage.DISCOVER_BEHAVIOUR__ROBOT:
