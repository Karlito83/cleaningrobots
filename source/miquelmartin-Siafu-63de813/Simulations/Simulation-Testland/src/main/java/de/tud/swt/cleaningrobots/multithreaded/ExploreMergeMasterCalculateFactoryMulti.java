...
public class ExploreMergeMasterCalculateFactoryMulti extends RobotFactoryMulti {

	public ExploreMergeMasterCalculateFactoryMulti (WorkingConfiguration configuration)
	{
		super(configuration);
	}
